        ...
        <div className="w-full max-w-[520px]">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[18px] font-semibold text-white">Create account</div>
                <div className="text-[12px] text-white/55">Instant access after purchase</div>
              </div>
            </div>

            <form onSubmit={onSubmit} className="mt-6 space-y-3">
              <div>
                <label className="text-[12px] font-semibold text-white/60">Username</label>
                <input
                  value={username}
          ...
          <div className="mt-4 text-center text-[11px] text-white/35">Auth por cookie httpOnly + /api/auth/me.</div>
        </div>
      </main>
    </div>
  )
